...
// Verificar si se ha enviado el formulario para eliminar una categoría
if(isset($_POST['id'])) {
    $idCategoria = limpiarDatos($_POST['id']);
    // Consulta SQL para actualizar el estado de la categoría a 0
    $queryActualizar = "UPDATE categoria SET estatus = 0 WHERE Id_Categoria = $idCategoria";
...
// Verificar si se ha enviado el formulario para agregar una nueva categoría
if(isset($_POST['nombre']) && isset($_POST['descripcion'])) {
    ...
    $queryInsertar = "INSERT INTO categoria (Nombre_Cat, Descripcion_Cat, estatus) VALUES ('$nombre', '$descripcion', 1)";
            ...
            <nav class="col-md-2 bg-light sidebar rounded-right">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Vender</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            // Iterar sobre los resultados y mostrar cada categoría
                            while ($fila = mysqli_fetch_assoc($resultado)) {
                                echo "<tr>";
                                echo "<td style='display:none;'>" . $fila['Id_Categoria'] . "</td>"; // Ocultar el ID
                                echo "<td>" . $fila['Nombre_Cat'] . "</td>";
                                echo "<td>" . $fila['Descripcion_Cat'] . "</td>";
                                echo "<td>";
                                echo "<a href='editar_categoria.php?id=" . $fila['Id_Categoria'] . "' class='btn btn-primary'><i class='bi bi-pen'></i> Editar</a> ";
                                echo "<button class='btn btn-danger btn-eliminar' data-id='" . $fila['Id_Categoria'] . "'>Eliminar</button>";
                                echo "</td>";
                                echo "</tr>";
                            }
